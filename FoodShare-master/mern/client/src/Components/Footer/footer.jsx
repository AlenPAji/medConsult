            ...
            <div className="custom-main-footer container">
                <footer className="pt-5 pb-3">
                    <div className="row">
                        ...
                        <div className="col-4 ">
                            <h5>About Us</h5>
                            <p className=' p-0'>Welcome to MedConsult, your online hub for expert medical guidance. Our team of compassionate professionals provides personalized care and support, ensuring confidentiality and convenience. With a focus on evidence-based practices, we're dedicated to making quality healthcare accessible to all. Trust MedConsult for reliable advice and solutions tailored to your needs.</p>
                        </div>
